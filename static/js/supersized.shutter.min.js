...
sel.data("wid",sel.children(":first-child").width());sel.css({"width":0,"visibility":"visible","opacity":1,"position":"relative"});if(Modernizr_.csstransitions){sel.addClass("addTextAni");if(browserWebkit)sel.css({"width":sel.data("wid")});else setTimeout(function(){sel.css({"width":sel.data("wid")})},15)}else sel.animate({"width":sel.data("wid")},1E3,"easeInOutQuart")})},aniTime*2);$(".supersized-nav li").find("a").removeClass("active");$(".supersized-nav li").eq(vars.current_slide).find("a").addClass("active");
if(api.options.progress_bar&&!vars.is_paused)theme.progressBar()},progressBar:function(){$(vars.progress_bar).stop().css({left:-$(window).width()}).animate({left:0},api.options.slide_interval)},min_thumb:function(){}};$.supersized.themeVars={progress_delay:false,thumb_page:false,thumb_interval:false,image_path:"images/supersized/",play_button:"#pauseplay",next_slide:"#nextslide",prev_slide:"#prevslide",next_thumb:"#nextthumb",prev_thumb:"#prevthumb",slide_caption:"#slidecaption",slide_current:".slidenumber",
slide_total:".totalslides",slide_list:"#slide-list",thumb_tray:"#thumb-tray",thumb_list:"#thumb-list",thumb_forward:"#thumb-forward",thumb_back:"#thumb-back",tray_arrow:"#tray-arrow",tray_button:"#tray-button",progress_bar:"#progress-bar"};$.supersized.themeOptions={progress_bar:1,mouse_scrub:0}})(jQuery);
